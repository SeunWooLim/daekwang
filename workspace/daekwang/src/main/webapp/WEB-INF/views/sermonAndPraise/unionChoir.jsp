...
<div id="wrap">
	...
	<div class="moviewrap">
		<ul id="results" class="movieul">
			<li>	
				<a href="https://www.youtube.com/playlist?list=PLwcdqPJXVv0YUuRYaqlDZdv2kDt8K4gvQ" target="_blank">
					<div class="mwrap">
						<img width="222" height="118" src="<c:url value="/resources/img/youtube.jpg"/>">
						<div class="text">
							<p class="title">배너클릭시 연합찬양대 유튜브채널로 이동합니다.</p>
...
<script type="text/javascript">
    var playlist = 'PLwcdqPJXVv0YUuRYaqlDZdv2kDt8K4gvQ';
           ...
           "https://www.googleapis.com/youtube/v3/playlistItems", {
               ...
               function(data){
                   ...
                   $.each(data.items, function(i, item){
                       ...
                       output=                    	   	 
								'<li>'+
									'<a href="videoDetail.do?vid=' + vId +'&desc=' + desc + '&menu=4&playlist=' + playlist + '">'+
										'<div class="mwrap">' +
											'<img width="222" height="118" src=\"//img.youtube.com/vi/' + vId + '/mqdefault.jpg\">' +
											'<div class="text">' +
												'<p class="title">' + vTitle + '</p>' +
												'<p class="text">Union Choir</p>' +
											'</div>' +
										'</div>' +
									 '</a>' +
								'</li>'
