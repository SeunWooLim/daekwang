...
<div id="wrap">
	...
	<div class="nextgene_wrap1">
		...
		<!-- 로컬서버 경로 -->
		<img alt="" src="<c:url value="/"/>resources/img/deptImage/${sapVo2.PRAISE_PHOTO_RENAME }">
	...
	<div class="moviewrap">
		<ul id="results" class="movieul">
			<li>	
				<a href="https://www.youtube.com/playlist?list=PLwcdqPJXVv0ZVyeuDgSUlBBlIUnKSiGoW" target="_blank">
					<div class="mwrap">
						<img width="222" height="118" src="<c:url value="/resources/img/youtube.jpg"/>">
						<div class="text">
							<p class="title">배너클릭시 임마누엘찬양대 유튜브채널로 이동합니다.</p>
           ...
           "https://www.googleapis.com/youtube/v3/playlistItems", {
               ...
               function(data){
                   ...
                   $.each(data.items, function(i, item){
                       ...
                       output=                    	   	 
							'<li>'+
								'<a href="videoDetail.do?vid=' + vId +'&desc=' + desc + '&menu=8&playlist=' + playlist + '">'+
									'<div class="mwrap">' +
										'<img width="222" height="118" src=\"//img.youtube.com/vi/' + vId + '/mqdefault.jpg\">' +
										'<div class="text">' +
											'<p class="title">' + vTitle + '</p>' +
											'<p class="text">Immanuel Choir</p>' +
										'</div>' +
									'</div>' +
								 '</a>' +
							'</li>'
