...
<div id="wrap">
	...
	<div class="moviewrap">
		<ul id="results" class="movieul">
			<li>	
				<a href="https://www.youtube.com/playlist?list=PLwcdqPJXVv0Z7XKbzvl4hWkHQUUawac9e" target="_blank">
					<div class="mwrap">
						<img width="222" height="118" src="<c:url value="/resources/img/youtube.jpg"/>">
						<div class="text">
							<p class="title">배너클릭시 특별행사 유튜브채널로 이동합니다.</p>
...
<script type="text/javascript">
    var playlist = 'PLwcdqPJXVv0Z7XKbzvl4hWkHQUUawac9e';
           ...
           "https://www.googleapis.com/youtube/v3/playlistItems", {
               ...
               function(data){
                   ...
                   $.each(data.items, function(i, item){
                       ...
                       output=                    	   	 
								'<li>'+
									'<a href="videoDetail.do?vid=' + vId +'&desc=' + desc + '&menu=6&playlist=' + playlist + '">'+
										'<div class="mwrap">' +
											'<img width="222" height="118" src=\"//img.youtube.com/vi/' + vId + '/mqdefault.jpg\">' +
												
											'<div class="text">' +
												'<p class="title">' + vTitle + '</p>' +
												'<p class="text">Special Event</p>' +
											'</div>' +
										'</div>' +
									 '</a>' +
								'</li>'
