...
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/css3_menu.css"/>">
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/style.css"/>">
<script src="<c:url value="/resources/js/jquery-3.3.1.min.js"/>"></script>
<script src="<c:url value="/resources/ckeditor/ckeditor.js"/>"></script>
<script src="<c:url value="/resources/js/jquery-migrate-1.2.1.min.js"/>"></script>
<script src="<c:url value="/resources/js/jquery-ui.min.js"/>"></script>
<script src="<c:url value="/resources/js/jquery.easings.min.js"/>"></script>
<script src="<c:url value="/resources/js/tweenMax.js"/>"></script>
...
<script src="<c:url value="/resources/js/imgreload.js"/>"></script>
