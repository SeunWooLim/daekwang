	...
	<!--container s-->
		<div id="container">
			...
			<div class="category_wrap">
				<form action="flowerPhotoAdmin.do" method="post">
					<ul class="ul_form1">
						...
						<li>
							<a href="flowerPhotoAdmin.do" class="btnform2">전체보기</a>
						</li>
					</ul>
				</form>
			...
			<div class="table_wrap">
									...
									<div class="form">
										...
										<ul>
											<li>
												...
												<input type="text" id="wPA" name="wPA" value="${flowerPhoto.memberVo.MEMBER_NAME }" readonly/>
											...
											<li>
												<label>제목</label>
												<input type="text" id="wPA_Dep" name="BOARD_TITLE" value="${flowerPhoto.BOARD_TITLE }"/>
											</li>
											<li>
												<label for="wPA_context" style="vertical-align:top;">내용</label>
												<textarea id="wPA_context<%= ediNum %>" name="BOARD_CONTENT">${flowerPhoto.BOARD_CONTENT }</textarea>
				...
				<ul class="board_page">
					<li>
						<c:url var="first" value="flowerPhotoAdmin.do">
					...
					<li>
						<c:url var="prev" value="flowerPhotoAdmin.do">
							<c:param name="currentPage" value="${currentPage}" />
					...
					<c:forEach var="p" begin="${startPage }" end="${endPage }" step="1">
						<li>
							<c:url var="page" value="flowerPhotoAdmin.do">
					...
					<li>
						<c:url var="next" value="flowerPhotoAdmin.do">
							<c:param name="currentPage" value="${currentPage }" />
					...
					<li>
						<c:url var="last" value="flowerPhotoAdmin.do">
...
<script type="text/javascript">
	...
	function deleteAction(){
		...
		if(confirm("정보를 삭제 하시겠습니까?")){
		    ...
		    var deleteYN = 'Y';
		    location.href="flowerPhotoAdmin.do?idx="+checkBox+"&currentPage="+currentPage+"&deleteFlag="+deleteYN;      
		}
	}
