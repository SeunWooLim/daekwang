	...
	<!--container s-->
		<div id="container">
			...
			<div class="category_wrap">
				<form action="churchNoticeAdmin.do" method="post">
					<ul class="ul_form1">
						<li>
							<c:choose>
						...
						<li>
							<a href="churchNoticeAdmin.do" class="btnform2">전체보기</a>
						</li>
					</ul>
				</form>
			...
			<div class="table_wrap">
				<table>
					...
					<tbody>
						<c:forEach var="churchNotice" items="${list }">
							<tr>
								<td><input type="checkbox" name="checkBox" value="${churchNotice.BOARD_NO }" id="check2"/><label for="check2"></label> </td>
								<td><%= num-- %></td>
									...
									<div class="form">
										...
										<ul>
											<li>
												...
												<input type="text" id="wPA" name="wPA" value="${churchNotice.memberVo.MEMBER_NAME }"/>
											...
											<li>
												<label>제목</label>
												<input type="text" id="wPA_Dep" name="BOARD_TITLE" value="${churchNotice.BOARD_TITLE }"/>
											</li>
											<li>
												<label for="wPA_context" style="vertical-align:top;">내용</label>
												<textarea id="wPA_context<%= ediNum %>" name="BOARD_CONTENT">${churchNotice.BOARD_CONTENT }</textarea>
				...
				<ul class="board_page">
					<li>
						<c:url var="first" value="churchNoticeAdmin.do">
					...
					<li>
						<c:url var="prev" value="churchNoticeAdmin.do">
							<c:param name="currentPage" value="${currentPage}" />
					...
					<c:forEach var="p" begin="${startPage }" end="${endPage }" step="1">
						<li>
							<c:url var="page" value="churchNoticeAdmin.do">
					...
					<li>
						<c:url var="next" value="churchNoticeAdmin.do">
							<c:param name="currentPage" value="${currentPage }" />
					...
					<li>
						<c:url var="last" value="churchNoticeAdmin.do">
