...
public class MemberVo {
	...
	public MemberVo(int mEMBER_NO, String mEMBER_ID, String mEMBER_PWD, String mEMBER_NAME, String mEMBER_PHONE,
			String mEMBER_DETAIL, String mEMBER_FG, String mEMBER_USEYN) {
		super();
		MEMBER_NO = mEMBER_NO;
		MEMBER_ID = mEMBER_ID;
	...
	public String toString() {
		return "MemberVo [MEMBER_NO=" + MEMBER_NO + ", MEMBER_ID=" + MEMBER_ID + ", MEMBER_PWD=" + MEMBER_PWD
				+ ", MEMBER_NAME=" + MEMBER_NAME + ", MEMBER_PHONE=" + MEMBER_PHONE + ", MEMBER_DETAIL=" + MEMBER_DETAIL
				+ ", MEMBER_FG=" + MEMBER_FG + ", MEMBER_USEYN=" + MEMBER_USEYN + "]";
	}
